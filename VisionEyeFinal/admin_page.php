...
<section class="dashboard">
   <div style="text-align: center; margin: 2rem 0;">
      <a href="report.php" class="btn">View Sales Report</a>
   </div>
   <div class="box-container">
      ...
      <div class="box">
      <?php
         $select_sold = $conn->prepare("SELECT SUM(quantity) AS total_sold FROM order_items");
         $select_sold->execute();
         $fetch_sold = $select_sold->fetch(PDO::FETCH_ASSOC);
         $total_sold = $fetch_sold['total_sold'] ?? 0;
      ?>
      <h3><?= $total_sold; ?></h3>
      <p>products sold</p>
      <a href="admin_orders.php" class="btn">see orders</a>
